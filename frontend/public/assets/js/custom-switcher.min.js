...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("NixlotHeader", 'light');
        // localStorage.setItem("NixlotMenu", 'light');
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("NixlotHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotfullwidth", true);
        localStorage.removeItem("Nixlotboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotboxed", true);
        localStorage.removeItem("Nixlotfullwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotregular", true);
        localStorage.removeItem("Nixlotclassic");
        localStorage.removeItem("Nixlotmodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotclassic", true);
        localStorage.removeItem("Nixlotregular");
        localStorage.removeItem("Nixlotmodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotmodern", true);
        localStorage.removeItem("Nixlotregular");
        localStorage.removeItem("Nixlotclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotheaderfixed", true);
        localStorage.removeItem("Nixlotheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("Nixlotheaderscrollable", true);
        localStorage.removeItem("Nixlotheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Nixlotmenufixed", true);
        localStorage.removeItem("Nixlotmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("Nixlotmenuscrollable", true);
        localStorage.removeItem("Nixlotmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("Nixlotverticalstyles", 'closed');
    });
    /* Closed Sidemenu End */
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("Nixlotverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("Nixlotverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("Nixlotverticalstyles", 'overlay');
    });
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("Nixlotverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("Nixlotnavstyles", 'menu-click');
        localStorage.removeItem("Nixlotverticalstyles");
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("Nixlotnavstyles", 'menu-hover');
        localStorage.removeItem("Nixlotverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("Nixlotnavstyles", 'icon-click');
        localStorage.removeItem("Nixlotverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("Nixlotnavstyles", 'icon-hover');
        localStorage.removeItem("Nixlotverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("Nixlotlayout");
        localStorage.setItem("Nixlotverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("Nixlotlayout", 'horizontal');
        localStorage.removeItem("Nixlotverticalstyles");
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem("Nixlotrtl", true);
        localStorage.removeItem("Nixlotltr");
        rtlFn(); 
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("Nixlotltr", true);
        localStorage.removeItem("Nixlotrtl");
        ltrFn();
        if (document.querySelector(".noUi-target")) {
            document.querySelectorAll(".noUi-origin").forEach((e) => {
...
function lightFn() {
    ...
    localStorage.removeItem("NixlotbgColor");
    localStorage.removeItem("Nixlotheaderbg");
    localStorage.removeItem("Nixlotbgwhite");
    localStorage.removeItem("Nixlotmenubg");
    localStorage.removeItem("Nixlotmenubg");
    checkOptions();
...
function darkFn() {
    ...
    localStorage.removeItem("Nixlotlighttheme");
    localStorage.removeItem("bodyBgRGB");
    localStorage.removeItem("NixlotbgColor");
    localStorage.removeItem("Nixlotheaderbg");
    localStorage.removeItem("Nixlotbgwhite");
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('NixlotHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('NixlotHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('NixlotHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('NixlotHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('NixlotHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('NixlotMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('NixlotMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('NixlotMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('NixlotMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('NixlotMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('Nixlotboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('Nixlotheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('Nixlotmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('Nixlotheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('Nixlotmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('Nixlotclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('Nixlotmodern')) {
